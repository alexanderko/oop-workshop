...
public class CheckoutServiceTest {
    ...
    void useOffer__addOfferPoints() {
        ...
        checkoutService.useOffer(new Offer(standardExpirationDate, new FlatReward(6, 2)));
        Check check = checkoutService.closeCheck();
    ...
    void useOffer__factorByCategory() {
        ...
        checkoutService.useOffer(new Offer(standardExpirationDate, new FactorReward(Category.MILK, 2)));
        Check check = checkoutService.closeCheck();
    ...
    void useOffer__pastItsExpirationDate__doNothing() {
        ...
        checkoutService.useOffer(new Offer(expiredDate, new FactorReward(Category.MILK, 2)));
        Check check = checkoutService.closeCheck();
    ...
    void useOffer__whenItsExpirationEqualToCurrent() {
        ...
        checkoutService.useOffer(new Offer(equalExpirationDate, new FactorReward(Category.MILK, 2)));
        Check check = checkoutService.closeCheck();
    ...
    void addProduct__whenOfferIsAlreadyUsed__applyIt() {
        ...
        checkoutService.useOffer(new Offer(expirationDate, new FactorReward(Category.MILK, 2)));
